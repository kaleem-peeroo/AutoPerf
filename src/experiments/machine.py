...
class Machine:
    ...
    def add_run_output(self, run_output):
        ...
        run_output = run_output.replace("stdout:", "")
        run_output = run_output.replace("stderr:", "")
        run_output = run_output.replace("RTI Connext DDS", "")
        run_output = run_output.replace("Test ended.", "")
        run_output = run_output.replace("Finishing test due to timer...", "")
        run_output = run_output.replace("Finishing test...\n", "")
        run_output = run_output.replace("Research License issued to City University of London (CULONDON02-UP) ... ", "")
        run_output = run_output.replace("For non-production use only.\n", "")
        run_output = run_output.replace("Expires on 22-may-2025\n", "")
        run_output = run_output.replace("Please contact support@rti.com with any questions or comments.", "")
        run_output = run_output.replace("RTI Perftest Master", "")
        run_output = run_output.replace("(master)", "")
        run_output = run_output.replace("( 7.3.0)", "")
        run_output = run_output.replace("Transport Configuration:", "")
        run_output = run_output.replace("Kind: UDPv4", "")
        run_output = run_output.replace("Use Multicast: True", "")
        run_output = run_output.replace("Use Multicast: False", "")
        run_output = run_output.replace("(master)", "")
        run_output = run_output.replace("48287dd", "")
        run_output = run_output.replace("Perftest Configuration:", "")
        run_output = run_output.replace("Keyed: No", "")
        run_output = run_output.replace("Subscriber ID: ", "")
        run_output = run_output.replace("Publisher ID: ", "")
        run_output = run_output.replace("Data Size: ", "")
        run_output = run_output.replace("Receive using: Listeners", "")
        run_output = run_output.replace("Domain:", "")
        run_output = run_output.replace("Perftest Configuration:", "")
        run_output = run_output.replace("Reliability: ", "")
        run_output = run_output.replace("Mode: THROUGHPUT TEST", "")
        run_output = run_output.replace("(Use \"-latencyTest\" for Latency Mode)", "")
        run_output = run_output.replace("Latency count: 1 latency sample every 100 samples", "")
        run_output = run_output.replace("Batching: No (Use \"-batchSize\" to setup batching)", "")
        run_output = run_output.replace("Publication Rate: Unlimited (Not set)", "")
        run_output = run_output.replace("Reliable", "")
        run_output = run_output.replace("Execution time: ", "")
        run_output = run_output.replace("seconds", "")
        run_output = run_output.replace("Dynamic Data: No", "")
        run_output = run_output.replace("CRC Enabled: No", "")
        run_output = run_output.replace("PRC Enabled: No", "")
        run_output = run_output.replace("Message Length Header Extension Enabled: No", "")
        run_output = run_output.replace("FlatData: No", "")
        run_output = run_output.replace("Zero Copy: No", "")
        run_output = run_output.replace("Asynchronous Publishing: No", "")
        run_output = run_output.replace("XML File:", "")
        run_output = run_output.replace("perftest_qos_profiles.xml", "")
        run_output = run_output.replace("Waiting to discover", "")
        run_output = run_output.replace("subscribers ...", "")
        run_output = run_output.replace("publishers ...", "")
        run_output = run_output.replace("Waiting for subscribers announcement ...", "")
        run_output = run_output.replace("Sending 50 initialization pings ...", "")
        run_output = run_output.replace("Sending data ...", "")
        run_output = run_output.replace("Network capture: No", "")
        run_output = run_output.replace("ublisher ID:", "")
        run_output = run_output.replace("Latency results are only shown when -pidMultiPubTest = 0", "")
        run_output = run_output.replace("\n\n\n", "")
        run_output = run_output.replace("\n\n", "")
        run_output = run_output.replace("\t", "")
        # Remove whitespaces with more than 1 space
        run_output = re.sub(r'\s+', ' ', run_output)
        run_output = re.sub(r'\d \d', '', run_output)
        # Check if run_output is just numbers
        if run_output.split(":")[-1].isdigit():
            run_output = ""

        run_output = run_output.strip()

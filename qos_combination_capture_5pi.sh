...
python index.py configs/5Pi/qos_combination_capture_1KB_PPSS.json 1.5 -skip-confirmation |& tee qos_combination_capture_1KB_PPSS_output.txt
python index.py configs/5Pi/qos_combination_capture_32KB_PPSS.json 1.5 -skip-confirmation |& tee qos_combination_capture_32KB_PPSS_output.txt
python index.py configs/5Pi/qos_combination_capture_64KB_PPSS.json 1.5 -skip-confirmation |& tee qos_combination_capture_64KB_PPSS_output.txt
python index.py configs/5Pi/qos_combination_capture_128KB_PPSS.json 1.5 -skip-confirmation |& tee qos_combination_capture_128KB_PPSS_output.txt
